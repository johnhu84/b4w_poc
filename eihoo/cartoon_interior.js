...
function init_controls() {
    ...
    /*for (var i = 0; i < 10000; i++) {
        m_data.load("blend_data/untitled3.json", loaded_cb);//, null, null, true);
    }*/

    document.getElementById("load-1").addEventListener("click", function(e) {
        //for (var i = 0; i < 10000; i++) {
            m_data.load("blend_data/curtain.json");//, loaded_cb, null, null, true);
            m_data.load("blend_data/camera.json");//, loaded_cb, null, null, true);
        //}
    });
    document.getElementById("load-2").addEventListener("click", function(e) {
        ...
        //m_data.load("blend_data/tv.json");//, loaded_cb, null, null, true);
	for (var i in objs) {
		if (!objs[i].endsWith("environment.json"))		
			m_data.load(objs[i]);
	}
    });
    ...
    document.getElementById("load-5").addEventListener("click", function(e) {
        ...
        m_data.load("blend_data/furn-2.json");//, loaded_cb, null, null, true);
    });
